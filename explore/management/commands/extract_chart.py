...
def _layout_overlay(rects, band_rects, words, canvas):
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--layout", action="store_true",
                            help="Emit a layout overlay (node id -> geometry, band "
                                 ...
                                 "spec. Regenerate it wholesale on every chart PDF "
    ...
    def handle(self, *args, **opts):
        ...
        if opts["layout"]:
            ...
            overlay, stats = _layout_overlay(rects, band_rects, words, canvas)
